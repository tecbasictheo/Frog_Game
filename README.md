...
\\
This game is a simple Frogger, with a simple game mechanic coded in python. \ To beat each level the frog needs to get to the top of the screen. Jumping from petal to petal, without falling into the water or leaving the screen.\
...
`idea` <- The virtual python environment.\
